...
- Cada `Step Action` ejecutable debe tener su `Stept Expected Result` (formato ADO, ver `plantillas/artefactos/04-casos-prueba.template.md`). La fila de `@Precondiciones` puede dejarlo vacío.
