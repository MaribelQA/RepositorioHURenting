...
- **Entrada**: `resultado/HU-<id>/04-casos-prueba-HU-<id>.md` + destino ADO (organización, proyecto, Test Plan/Suite).
- **Salida**: Work Items (Test Case) en ADO + `resultado/HU-<id>/05-registro-ado-HU-<id>.md` + actualizar `00`.
