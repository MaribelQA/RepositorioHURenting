...
argument-hint: Archivo de casos qa-analisis-casos/HU-<id>/04-casos-prueba-HU-<id>.md y destino en ADO (organización/proyecto/Test Plan/Suite o IDs).
...
## Entradas esperadas
- **Obligatoria**: archivo de casos `qa-analisis-casos/HU-<id>/04-casos-prueba-HU-<id>.md` con `Estado: Completado`.
...
- Reporte de registro en `qa-analisis-casos/HU-<id>/05-registro-ado-HU-<id>.md` (a partir de
  `.github/plantillas/artefactos/05-registro-ado.template.md`): IDs creados, enlaces, y resultado por
